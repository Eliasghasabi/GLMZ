...
export const SKINS: SkinDef[] = [
  ...
  // ─────────────────────────────────────────────────────────────
  //  EXPANDED SKIN CATALOG — Studio Edition
  //  Each entry below is engineered to look distinctly different from
  //  every other skin. Patterns, palettes and FX were chosen so the
  //  new skins read as new *materials*, not recolours.
  // ─────────────────────────────────────────────────────────────
  {
    id: "plasma",
    name: "Plasma Storm",
    rarity: "epic",
    desc: "Charged energy lattice. Cells of raw plasma held in a magnetic cradle.",
    swatch: ["#1ad3ff", "#3a0d6a"],
    surface: { pattern: "hex", palette: [0x0e0830, 0x3a0d6a, 0x1ad3ff], repeat: 4, metalness: 0.55, roughness: 0.18 },
    accent: 0x1ad3ff,
    muzzleColor: 0x66e6ff,
    tracerColor: 0x1ad3ff,
    fx: "pulse",
    trail: 0x1ad3ff,
    unlock: { kind: "kills", value: 180 },
  },
  {
    id: "glitch",
    name: "Glitch Reality",
    rarity: "legendary",
    desc: "Reality-tearing data corruption. The weapon doesn't quite exist in this dimension.",
    swatch: ["#ff2e6e", "#1a3d0a"],
    surface: { pattern: "digital", palette: [0x0a0a0a, 0xff2e6e, 0x1a3d0a, 0xe6ff00], repeat: 3, metalness: 0.65, roughness: 0.32 },
    accent: 0xff2e6e,
    muzzleColor: 0xff66a0,
    tracerColor: 0xff2e6e,
    fx: "flicker",
    trail: 0xff2e6e,
    unlock: { kind: "score", value: 38000 },
  },
  {
    id: "frostbite",
    name: "Frostbite",
    rarity: "epic",
    desc: "Crystalline ice lattice grown over cold-forged steel. Looks cold to the touch.",
    swatch: ["#d6ecff", "#1a3a5e"],
    surface: { pattern: "splinter", palette: [0xc4e0ff, 0x4a86c8, 0x1a3a5e, 0xeaf6ff], repeat: 2, metalness: 0.7, roughness: 0.18 },
    accent: 0x88d4ff,
    muzzleColor: 0xb4e4ff,
    tracerColor: 0x88d4ff,
    fx: "shimmer",
  ...
  },
  {
    ...
    name: "Blood Moon",
    rarity: "legendary",
    desc: "Molten bloodstone veined with crimson. Forged under an eclipse.",
    swatch: ["#c41818", "#1a0606"],
    surface: { pattern: "marble", palette: [0x1a0606, 0xc41818, 0x5a0a0a], repeat: 2.4, metalness: 0.62, roughness: 0.34 },
    accent: 0xff3838,
    muzzleColor: 0xff5a5a,
    tracerColor: 0xff3838,
    fx: "scroll",
    trail: 0xc41818,
    unlock: { kind: "kills", value: 350 },
  },
  {
    id: "void",
    name: "Voidwalker",
    rarity: "legendary",
    desc: "Starfield embedded in deep-space black. Stars shift as the weapon moves.",
    swatch: ["#5a2eff", "#050108"],
    surface: { pattern: "hex", palette: [0x050108, 0x2a1066, 0x5a2eff], repeat: 5, metalness: 0.92, roughness: 0.14 },
    accent: 0x8a5aff,
    muzzleColor: 0x8a5aff,
    tracerColor: 0x5a2eff,
    fx: "flicker",
    trail: 0x5a2eff,
    unlock: { kind: "score", value: 52000 },
  },
  {
    id: "solaris",
    name: "Solar Flare",
    rarity: "legendary",
    desc: "Circuit-traced solar plasma. The weapon radiates captured sunlight.",
    swatch: ["#ffae00", "#5a1a00"],
    surface: { pattern: "circuit", palette: [0x1a0a00, 0xffae00, 0xff6a00], repeat: 3, metalness: 0.78, roughness: 0.28 },
    accent: 0xffd76a,
    muzzleColor: 0xffd76a,
    tracerColor: 0xffae00,
    fx: "pulse",
    trail: 0xffae00,
    unlock: { kind: "wave", value: 12 },
  },
  {
    id: "toxic",
    name: "Toxic Hazard",
    rarity: "epic",
    desc: "Industrial hazard stripes over a corrosive acid-green substrate.",
    swatch: ["#9eff3a", "#1a2208"],
    surface: { pattern: "hazard", palette: [0x1a2208, 0x9eff3a, 0x2a3a0a], repeat: 3, metalness: 0.5, roughness: 0.42 },
    accent: 0x9eff3a,
    muzzleColor: 0xc6ff66,
    tracerColor: 0x9eff3a,
    fx: "shimmer",
    unlock: { kind: "headshots", value: 60 },
  },
  {
    id: "shadow",
    name: "Shadow Protocol",
    rarity: "epic",
    desc: "Matte obsidian with carbon-fibre accents. Whisper-quiet, perfectly black.",
    swatch: ["#0a0a0a", "#1a1f24"],
    surface: { pattern: "twill", palette: [0x080808, 0x1a1f24, 0x020202], repeat: 5, metalness: 0.4, roughness: 0.62 },
    accent: 0x4d9fff,
    muzzleColor: 0x6fb2ee,
    tracerColor: 0x4d9fff,
    unlock: { kind: "kills", value: 220 },
  },
  {
    id: "crimson",
    name: "Crimson Fury",
    rarity: "rare",
    desc: "Pulsing red tiger-stripe over combat-black. Built for the front line.",
    swatch: ["#c41e3a", "#1a0608"],
    surface: { pattern: "tiger", palette: [0x1a0608, 0xc41e3a, 0x8a0e1e], repeat: 2, metalness: 0.45, roughness: 0.68 },
    accent: 0xff3052,
    muzzleColor: 0xff5a72,
    tracerColor: 0xff3052,
    fx: "pulse",
