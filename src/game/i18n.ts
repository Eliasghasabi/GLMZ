...
export const STRINGS: Record<LangId, Record<string, string>> = {
  ...
  fa: {
    ...
    subtagline: "خیابان الیاس // بقای موجی // عملیات شبانه",
    play: "شروع بازی",
    settings: "تنظیمات",
    ...
    crosshair: "نشانه‌گير",
    howToPlay: "راهنما",
    setCallsign: "انتخاب نام",
    headphonesHint: "پیشنهاد: از هدفون استفاده کنید · برای قفل ماوس روی بازی کلیک کنید",
    createdBy: "ساخته‌ی الیاس",
    rotateDevice: "گوشی را بچرخانید",
    rotateHint: "شَدُو اِسترایک در حالت افقی اجرا می‌شود. لطفاً گوشی را افقی بگیرید.",

    settingsTitle: "تنظیمات",
    difficulty: "سطح دشواری",
    mouseSensitivity: "حساسیت ماوس",
    fieldOfView: "میدان دید",
    masterVolume: "صدای کلی",
    sfxVolume: "صدای افکت‌ها",
    graphicsQuality: "کیفیت گرافیک",
    language: "زبان",
    difficultyEasy: "تازه‌کار",
    difficultyNormal: "عملیاتی",
    difficultyHard: "کهنه‌سرباز",
    difficultyEasyBlurb: "دشمنان کمتر و ضعیف‌تر. دقت بخشنده.",
    difficultyNormalBlurb: "تعادل کامل. تجربه‌ی استاندارد بازی.",
    difficultyHardBlurb: "گروه‌های سرسخت، فشار بی‌وقفه، تیراندازی کشنده.",

    postProcessing: "افکت‌های تصویری",
    cinematicGrain: "نویز سینمایی",

    crosshairTitle: "نشانه‌گير",
    reticleStyle: "شکل نشانه",
    colour: "رنگ",
    gap: "فاصله",
    thickness: "ضخامت",
    length: "طول",
    outline: "خط دور",
    centreDot: "نقطه‌ی وسط",
    on: "روشن",
    off: "خاموش",
    reset: "بازنشانی",
    back: "بازگشت",
    livePreview: "نمایش زنده",

    loadoutTitle: "تجهیز سلاح",
    unlocked: "باز شده",
    operatorGear: "تجهیزات عملیاتی",
    gloves: "دستکش",
    sleeves: "آستین",
    wristGear: "مچ‌بند",
    options: "گزینه‌ها",
    weaponStats: "مشخصات سلاح",
    previewing: "در حال پیش‌نمایش",
    resetWeapon: "بازنشانی سلاح",
    dragToRotate: "بکشید تا بچرخد · اسکرول کنید برای زوم",

    wave: "موج",
    hostiles: "دشمن",
    hostile: "دشمن",
    score: "امتیاز",
    eliminations: "کشته‌ها",
    reloading: "در حال شارژ",
    killConfirmed: "کشته تأیید شد",
    killConfirmedHeadshot: "تأیید شد · شات سر",
    doubleKill: "دابل کیل",
    tripleKill: "تریپل کیل",
    killingSpree: "رشته کشتن",
    unstoppable: "توقف‌ناپذیر",
    rampage: "هیاهو",
    streak: "زنجیره",
    onFire: "در آتش",
    unlockedToast: "باز شد",
